...
/**
 * A StepBro runtime with minimal debugger functionality.
 * StepBroRuntime is a hypothetical (aka "StepBro") "execution engine with debugging support":
 ...
 * Since the StepBroRuntime is completely independent from VS Code or the Debug Adapter Protocol,
 ...
 */
export class StepBroRuntime extends EventEmitter {
	...
	/**
	 * "Step into" for StepBro debug means: go to next character
	 */
	...
	/**
	 * "Step out" for StepBro debug means: go to previous character
	 */
	public stepOut() {
		if (typeof this.currentColumn === 'number') {
			this.currentColumn -= 1;
