...
namespace StepBroCoreTest.Execution
{
    ...
    public class TestLayeredModuleUsage
    {
        ...
        public void ThreeCodeModulesSetup()
        {
            ...
            f.AppendLine("public " + typeof(LowLayerCodeModule).Name + " lowLevelObject = " + typeof(LowLayerCodeModule).Name);
            f.AppendLine("{");
            f.AppendLine("   IntProp: 12");
            f.AppendLine("}");
            f.AppendLine("public " + typeof(MidLayerCodeModule).Name + " midLevelObject = " + typeof(MidLayerCodeModule).Name);
            f.AppendLine("{");
            f.AppendLine("   LowLayer: lowLevelObject,");
            f.AppendLine("   IntProp: 2");
            f.AppendLine("}");
            f.AppendLine("public " + typeof(HighLayerCodeModule).Name + " highLevelObject = " + typeof(HighLayerCodeModule).Name);
            f.AppendLine("{");
