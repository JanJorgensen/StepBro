...
namespace StepBroCoreTest.Execution
{
    ...
    public class FormalTestSetupExecution
    {
        ...
        public void TestPartnerOnProcedureUsingThisModifier()
        {
            ...
            log.ExpectNext("2 - Pre - 9 MyFile.Helper - <no arguments>");
        ...
        public void TestSetupBasic()
        {
            ...
            log.ExpectNext("2 - Pre - 24 MyFile.TestCaseBaseSetup - <no arguments>");
            log.ExpectNext("3 - Normal - 6 Log - Doing setup for FirstTestCase");
            log.ExpectNext("3 - Post");
            log.ExpectNext("2 - Pre - 25 <DYNAMIC CALL> MyFile.FirstTestCase - ( (<empty>) )");
            log.ExpectNext("3 - Post");
            log.ExpectNext("2 - Pre - 26 MyFile.TestCaseBaseCleanup - <no arguments>");
            ...
            log.ExpectNext("3 - Post");
            log.ExpectNext("2 - Pre - 25 <DYNAMIC CALL> MyFile.SecondTestCase - ( (<empty>) )");
            log.ExpectNext("3 - Post");
            log.ExpectNext("2 - Pre - 26 MyFile.TestCaseBaseCleanup - <no arguments>");
            ...
            log.ExpectNext("3 - Post");
            log.ExpectNext("2 - Pre - 25 <DYNAMIC CALL> MyFile.ThirdTestCase - ( (<empty>) )");
            log.ExpectNext("3 - Post");
            log.ExpectNext("2 - Pre - 26 MyFile.TestCaseBaseCleanup - <no arguments>");
        ...
        public void TestPartnerOnTestList_WithReturn()
        {
            ...
            log.ExpectNext("1 - Pre - MyFile.ExecuteIt - <no arguments>");
            log.ExpectNext("2 - Normal - 8 Log - Before");
            log.ExpectNext("2 - Pre - 10 MyFile.Helper - <no arguments>");
            log.ExpectNext("3 - Post");
        ...
        public void TestSetupWithBaseTypes()
        {
            ...
            log.ExpectNext("4 - Normal - 10 - EXPECT: 5 < 9; Left: 5, Right: 9; Verdict: Pass");
            log.ExpectNext("4 - Post");
            ...
            log.ExpectNext("4 - Normal - 12 - EXPECT: 7 <= 8; Left: 7, Right: 8; Verdict: Pass");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 32 myfile.TestCaseBaseCleanup - <no arguments>");
        ...
        public void TestSetupCleanWithFrameworkFile()
        {
            ...
            log.ExpectNext("0 - Pre - TestRun - Starting");
            log.ExpectNext("1 - Pre - myfile.ExecuteAllTests - <no arguments>");
            log.ExpectNext("2 - Pre - 16 TestFramework.TestSuiteFormalTestExecution - <no arguments>");

            log.ExpectNext("3 - Pre - 28 TestFramework.TestSuiteEmptyPreTest - <no arguments>");
            log.ExpectNext("4 - Post");

            log.ExpectNext("3 - Normal - 34 Log - Starting Test: FirstTestCase");
            log.ExpectNext("3 - Pre - 36 TestFramework.TestCaseEmptySetup - <no arguments>");
            log.ExpectNext("4 - Normal - 7 Log - TestCaseEmptySetup FirstTestCase");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 37 <DYNAMIC CALL> myfile.FirstTestCase - ( (<empty>) )");
            log.ExpectNext("4 - Normal - 9 Log - Inside FirstTestCase");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 38 TestFramework.TestCaseEmptyCleanup - <no arguments>");
            ...
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 37 <DYNAMIC CALL> myfile.SecondTestCase - ( (<empty>) )");
            ...
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 37 <DYNAMIC CALL> myfile.ThirdTestCase - ( (<empty>) )");
        ...
        public void TestSetupWithFrameworkFile()
        {
            ...
            log.ExpectNext("0 - Pre - TestRun - Starting");
            log.ExpectNext("1 - Pre - myfile.ExecuteAllTests - <no arguments>");
            log.ExpectNext("2 - Pre - 30 TestFramework.TestSuiteFormalTestExecution - <no arguments>");

            log.ExpectNext("3 - Pre - 28 TestFramework.TestSuiteEmptyPreTest - <no arguments>");
            log.ExpectNext("4 - Post");

            log.ExpectNext("3 - Normal - 34 Log - Starting Test: FirstTestCase");
            log.ExpectNext("3 - Pre - 36 myfile.TestCaseSpecialSetup - <no arguments>");
            log.ExpectNext("4 - Normal - 11 Log - Doing special setup for FirstTestCase");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 37 <DYNAMIC CALL> myfile.FirstTestCase - ( (<empty>) )");
            log.ExpectNext("4 - Normal - 22 Log - Inside FirstTestCase");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 38 myfile.TestCaseCleanup - <no arguments>");
            log.ExpectNext("4 - Normal - 9 Log - Doing default cleanup for FirstTestCase");
            log.ExpectNext("4 - Post");

            log.ExpectNext("3 - Normal - 34 Log - Starting Test: SecondTestCase");
            log.ExpectNext("3 - Pre - 36 myfile.TestCaseSetup - <no arguments>");
            log.ExpectNext("4 - Normal - 7 Log - Doing default setup for SecondTestCase");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 37 <DYNAMIC CALL> myfile.SecondTestCase - ( (<empty>) )");
            log.ExpectNext("4 - Normal - 25 Log - Inside SecondTestCase");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 38 myfile.TestCaseSpecialCleanup - <no arguments>");
        ...
        public void TestSetupWithSpecialSetupFile()
        {
            ...
            log.ExpectNext("0 - Pre - TestRun - Starting");
            log.ExpectNext("1 - Pre - myfile.ExecuteAllTests - <no arguments>");
            log.ExpectNext("2 - Pre - 27 TestFramework.TestSuiteFormalTestExecution - <no arguments>");

            log.ExpectNext("3 - Pre - 28 myfile.MyPreTest - <no arguments>");
            log.ExpectNext("4 - Normal - 31 Log - MyPreTest:20");
            log.ExpectNext("4 - Post");

            log.ExpectNext("3 - Normal - 34 Log - Starting Test: FirstTestCase");
            log.ExpectNext("3 - Pre - 36 myfile.TestCaseLocalSetup - <no arguments>");
            log.ExpectNext("4 - Normal - 7 Log - TestCaseLocalSetup FirstTestCase");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 37 <DYNAMIC CALL> myfile.FirstTestCase - ( (<empty>) )");
            log.ExpectNext("4 - Normal - 19 Log - Inside FirstTestCase: 20");
            log.ExpectNext("4 - Post");
            log.ExpectNext("3 - Pre - 38 SpecialTest.TestCaseCleanup - <no arguments>");
            log.ExpectNext("4 - Normal - 8 Log - TestCaseCleanup FirstTestCase");
            log.ExpectNext("4 - Post");

            log.ExpectNext("3 - Normal - 34 Log - Starting Test: SecondTestCase");
            log.ExpectNext("3 - Pre - 36 SpecialTest.TestCaseSpecialSetup - <no arguments>");
            ...
            log.ExpectNext("3 - Normal - 34 Log - Starting Test: ThirdTestCase");
            log.ExpectNext("3 - Pre - 36 SpecialTest.TestCaseSetup - <no arguments>");
