...
namespace StepBro.HostSupport.Models
{
    public class ChronoListViewDynamicSettings
    {
        ...
        private double m_timestampWidth = 0;   // The width of the widest seen timestamp.
        private double m_lineHeaderWidth = 0;    // The right side of the widest line header (timestamp and type)
