    ...
    public static void Initialize(params IService[] hostServices)
    {
        ...
        m_addonManager = new AddonManager(
            (IAddonManager m) =>
            {
                ...
                {
                    var modulesListData = modulesListFile.GetPropertyBlockFromRealFile();
        ...
        try
        {
            ...
            m_textFileSystem = m_serviceManagerAdmin.Manager.Get<ITextFileSystem>();
        }
        catch (Exception ex)
        {
