        ...
        public override SBExpressionData Resolve(StepBroListener listener, SBExpressionData first, SBExpressionData last)
        {
            ...
            else
            {
                ...
                if (first.IsValueType && last.IsValueType)
                {
                    ...
                    {
                        return new SBExpressionData(Expression.LessThan(first.ExpressionCode, last.ExpressionCode));
                    }
                    ...
                    {
                        return new SBExpressionData(Expression.LessThan(first.ConvertToDouble().ExpressionCode, last.ExpressionCode));
                    }
