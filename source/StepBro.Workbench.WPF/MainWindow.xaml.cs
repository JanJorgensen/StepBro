...
namespace StepBro.Workbench.WPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public static readonly DependencyProperty IsWindowActivationEventOutputEnabledProperty = DependencyProperty.Register("IsWindowActivationEventOutputEnabled", typeof(bool), typeof(MainWindow), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty IsWindowRegistrationEventOutputEnabledProperty = DependencyProperty.Register("IsWindowRegistrationEventOutputEnabled", typeof(bool), typeof(MainWindow), new PropertyMetadata(false));
...
more about the enormous feature set this product provides.");
        ...
        private void OnOpenDocumentMenuItemClick(object sender, RoutedEventArgs e)
        {
            ...
            dialog.Filter = "Code files (*.sbs;*.cs;*.py)|*.sbs;*.cs;*.py|Text files (*.txt)|*.txt|All files (*.*)|*.*";
        ...
        private void UpdateStatusBar()
        {
            ...
            if (editor != null)
            {
                linePanel.Text = String.Format("Ln {0}", editor.Caret.Position.DisplayLine);
                columnPanel.Text = String.Format("Col {0}", editor.Caret.DisplayCharacterColumn);
                characterPanel.Text = String.Format("Ch {0}", editor.Caret.Position.DisplayCharacter);
