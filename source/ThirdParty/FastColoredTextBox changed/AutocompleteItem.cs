...
namespace FastColoredTextBoxNS
{
    ...
    public class AutocompleteItem
    {
        ...
        public AutocompleteCreator Parent { get; internal set; }
        ...
        /// </summary>
        public virtual int Compare(string fragmentText, int fragmentStart, string line, int column)
        {
            return this.Compare(fragmentText);
        }

        /// <summary>
        /// Compares fragment text with this item
        /// </summary>
        public virtual int Compare(string fragmentText)
        {
        ...
        /// <summary>
        /// Matching weight of the item. Used to sort the .
        /// </summary>
        ...
        public virtual void SetSelectionForTextToReplace(Range fragment, int fragmentStart, string line, int column)
        {
            var tb = fragment.tb;
    ...
    public class SnippetAutocompleteItem : AutocompleteItem
    {
        ...
        /// Compares fragment text with this item
        /// </summary>
        public override int Compare(string fragmentText)
        {
            if (Text.StartsWith(fragmentText, StringComparison.InvariantCultureIgnoreCase) &&
                   Text != fragmentText)
                return 100;
    ...
    public class MethodAutocompleteItem : AutocompleteItem
    {
        ...
        public override int Compare(string fragmentText, int fragmentStart, string line, int column)
        {
            return base.Compare(fragmentText, fragmentStart, line, column);
        }
